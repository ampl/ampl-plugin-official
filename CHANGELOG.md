...
### Fixed
- Updated parser to support `interval` notation
...
### Changed
- Check if AMPL binary is still valid at startup
...
### Changed
- Parser updates to avoid an unnecessary warning 


## [0.3.0]

### Changed
- `AMPL: Run file` command in the File Explorer context menu now runs the file being clicked [*Eric-Sirbu*]
- Bug fixes 
